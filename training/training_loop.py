...
def training_schedule(
    ...
    lod_training_kimg       = 6,      # Thousands of real images to show before doubling the resolution.
    lod_transition_kimg     = 6,      # Thousands of real images to show when fading in new layers.
